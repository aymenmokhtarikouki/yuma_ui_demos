...
const orderModel = [
  { id: "297980", title: "Cheesecake Box", customer: "Aymen Mokhtari", type: "Pickup", status: "new", time: "12:00", action: "Confirm", icon: "meal", urgency: false },
  { id: "297982", title: "Chocolate Snacks Bundle", customer: "Lina Barakat", type: "Delivery", status: "new", time: "12:06", action: "Confirm", icon: "delivery", urgency: true },
  { id: "297989", title: "Protein Lunch Bowl", customer: "Rayan Salem", type: "Pickup", status: "new", time: "12:11", action: "Confirm", icon: "meal", urgency: false },
  { id: "297991", title: "Vegan Wrap Pack", customer: "Nada Khoury", type: "Delivery", status: "new", time: "12:14", action: "Confirm", icon: "delivery", urgency: false },
  { id: "297981", title: "Weekly Meal Plan", customer: "Sami Obaid", type: "Scheduled delivery", status: "inprogress", phase: "driver_arriving", time: "13:30", action: "Confirm delivery", icon: "delivery", urgency: false },
  { id: "297977", title: "Daily Hot Meal", customer: "Nour Haddad", type: "Scheduled pickup", status: "inprogress", phase: "ready_pickup", time: "12:45", action: "Confirm pickup", icon: "pickup", urgency: false },
  { id: "297973", title: "Family Dinner Set", customer: "Tareq Hamdan", type: "Scheduled delivery", status: "inprogress", phase: "awaiting_handoff", time: "14:05", action: "Confirm delivery", icon: "delivery", urgency: false },
  { id: "297969", title: "Office Meal Tray", customer: "Mira Issa", type: "Scheduled pickup", status: "inprogress", phase: "preparing", time: "14:20", action: "Confirm pickup", icon: "pickup", urgency: false },
  { id: "297965", title: "Falafel Wrap Combo", customer: "Youssef Naim", type: "Pickup", status: "done", time: "11:14", action: null, icon: "meal", urgency: false },
  { id: "297970", title: "Fruit Bowl Pack", customer: "Nour Haddad", type: "Delivery", status: "done", time: "11:40", action: null, icon: "delivery", urgency: false },
  { id: "297954", title: "Chicken Rice Box", customer: "Salma Jaber", type: "Pickup", status: "done", time: "10:52", action: null, icon: "meal", urgency: false },
  { id: "297948", title: "Keto Snack Kit", customer: "Hadi Nasser", type: "Delivery", status: "done", time: "10:35", action: null, icon: "delivery", urgency: false }
];
...
function bindFocusToggle() {
  focusToggle.addEventListener("click", () => {
    setViewMode(state.viewMode === "focus" ? "orders" : "focus");
  });
}
...
function createRow(order) {
  ...
  row.className = `order-row row-${order.status} ${railClass} ${order.urgency ? "urgent" : ""}`;
...
function applyTitleWeighting() {
  ordersRoot.querySelectorAll(".order-row").forEach((row) => {
    ...
    row.classList.toggle("title-wrapped", title.scrollHeight > lh * 1.35);
  });
}
